...
// app.post("/api/todos", async (req, res) => {
//   try {
//     // Fetch the last todo to get the latest id
//     const lastTodo = await Todo.findOne().sort({ id: -1 });

//     // Set the new id (incrementing from last id or defaulting to 1)
//     const newId = lastTodo ? lastTodo.id + 1 : 1;

//     // Create new todo with the incremented id
//     const newTodoItem = await Todo.create({ ...req.body, id: newId });
